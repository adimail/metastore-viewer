...
def register():
    ...
    if request.method == 'POST':
        ...
        if role not in valid_roles:
            flash('Invalid role selected. Please choose Admin, Viewer, or Editor.', category='error')
        ...
        if User.query.filter_by(username=username).first():
            ...
            new_user = User(username=username, password=hashed_password, global_role=role)
